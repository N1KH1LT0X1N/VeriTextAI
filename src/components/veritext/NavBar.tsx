  ...
  return (
    <nav className="px-4 py-4 md:px-6 md:py-6" aria-label="Main">
      <div className="mx-auto flex max-w-6xl flex-col justify-between py-2 font-medium text-slate-900 md:flex-row md:items-center">
        ...
        <div
          className={clsx(
            'fixed bottom-0 left-0 right-0 top-0 z-40 flex flex-col items-end gap-4 bg-white pr-4 pt-14 transition-transform duration-300 ease-in-out motion-reduce:transition-none md:hidden',
